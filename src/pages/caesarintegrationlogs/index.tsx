        ...
        <Box m="20px">
            ...
            <Box sx={{ width: '100%' }}>
                ...
                <CustomTabPanel value={value} index={1}>
                    <SearchByFieldName Label='Transaction Id' onClickEvent={() => {console.log("TransactionId")}}></SearchByFieldName>
                </CustomTabPanel>
                <CustomTabPanel value={value} index={2}>
                    <SearchByFieldName Label='Search Text' onClickEvent={() => {console.log("Search Text")}}></SearchByFieldName>
                </CustomTabPanel>
